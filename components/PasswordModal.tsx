...
const PasswordModal:React.FC<{
    findPasswordHandler: () => void
}> = ({findPasswordHandler}) => {
    return(
        <div className="ReactModalPortal">
            <div className="ReactModal__Overlay ReactModal__Overlay--after-open Modal_overlay">
                <div className="ReactModal__Content ReactModal__Content--after-open Modal_content" tabIndex={-1} role={'dialog'} aria-modal="true" style={{height: 'max-content', width: 'max-content'}}>
                    <div id="modal-number" tabIndex={-1} style={{boxSizing: 'border-box', height: 'max-content', width: 'max-content', minHeight: '100%', placeContent: 'flex-start', alignItems: 'start', display: 'flex', flexFlow: 'column nowrap'}}>
                        <div className="theme-vermilion" tabIndex={-1} style={{boxSizing: 'border-box'}}>
                            <div className="BasicModal_modal" tabIndex={-1} style={{boxSizing: 'border-box', height: 'max-content', width: '400px', flex: '0 0 70px'}}>
                                <div className="BasicModal_header" tabIndex={-1} style={{boxSizing: 'border-box', height: '70px', width: '100%', flex: '0 0 70px'}}>
                                    <div tabIndex={-1} style={{boxSizing: 'border-box', height: '100%', minHeight: '100%', width: '100%', placeContent: 'flex-start', alignItems: 'center', display: 'flex', flexFlow: 'row nowrap'}}>
                                        <div tabIndex={-1} style={{boxSizing: 'border-box', width: '100%'}}>
                                            <span className="font-heading2 Text_basicText Text_color Text_inherit Text_font Text_primary Text_bold">비밀번호 찾기</span>
                                        </div>
                                        <div onClick={(e)=> {e.preventDefault(); findPasswordHandler();}} id="closeModal" role={'button'} tabIndex={0} style={{boxSizing: 'border-box', cursor: 'pointer'}}>
                                ...
                                <div tabIndex={-1} style={{boxSizing: 'border-box'}}>
                                    <div tabIndex={-1} style={{boxSizing: 'border-box', width: '100%', flex: '1 1 auto'}}>
                                        <form>
                                            <div tabIndex={-1} style={{boxSizing: 'border-box', padding: '20px 20px 30px'}}>
                                                <div tabIndex={-1} style={{boxSizing: 'border-box', height: '100%', minHeight: '100%', width: '100%', placeContent: 'flex-start', alignItems: 'start', display: 'flex', flexFlow: 'column nowrap', gap: '20px'}}>
                                                    <span className="font-normal Text_basicText Text_color Text_inherit Text_font Text_primary Text_bold">이메일 주소를 입력하시면 비밀번호 재설정 이메일이 발송됩니다.</span>
                                                        <div className="Input_component Input_medium" id="input-email" role={'button'} tabIndex={0} style={{boxSizing: 'border-box', cursor: 'text', width: '360px'}}>
                                                            <div tabIndex={-1} style={{boxSizing: 'border-box', height: '100%', minHeight: '100%', width: '100%', placeContent: 'flex-start', alignItems: 'center', display: 'flex', flexFlow: 'row nowrap', gap: '4px'}}>
                                                                <input name="email" type={'text'} placeholder="이메일 주소를 입력해 주세요." maxLength={50} value={''} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            <hr className="Divider_basicDivider Divider_lightGrey Divider_size1px Divider_vertical Divider_solid"></hr>
                                            <div tabIndex={-1} style={{boxSizing: 'border-box', padding: '30px 20px'}}>
                                                <div tabIndex={-1} style={{boxSizing: 'border-box', height: '100%', minHeight: '100%', width: '100%', placeContent: 'flex-start', alignItems: 'start', display: 'flex', flexFlow: 'row nowrap', gap: '10px'}}>
                                                    <button onClick={(e)=> {e.preventDefault(); alert('확인 버튼 클릭됨')}} id="submit-btn-of-find-password" type={'submit'} className="Button_basicButton Button_contained Button_primary Button_medium" style={{width: '360px'}}>확인</button>
                                                    <button onClick={(e)=> {e.preventDefault(); findPasswordHandler();}} id="dismiss-btn-of-find-password" className="Button_basicButton Button_outlined Button_primary Button_medium" style={{width: '360px'}}>돌아가기</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
