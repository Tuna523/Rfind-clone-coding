...
const LocationSelect:React.FC<{
...
}> = ({location,value,setPlaceHandler,resetValueHandler}) => {
    ...
    return(
    <div onClick={(e)=> {e.preventDefault(); handleOnClick(); setPlaceHandler(value); resetValueHandler();}} className="Radio_component Radio_round" tabIndex={-1} style={{boxSizing: 'border-box', placeContent: 'flex-start center', alignItems: 'center', display: 'flex', flexFlow: 'row nowrap', gap: '10px'}}>
